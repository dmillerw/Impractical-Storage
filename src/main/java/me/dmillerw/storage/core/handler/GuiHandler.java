...
public class GuiHandler implements IGuiHandler {
    ...
    public static enum Gui {
        ...
        public void openGui(EntityPlayer player) {
            player.openGui(ImpracticalStorage.instance, this.ordinal(), player.getEntityWorld(), 0, 0, 0);
        }

        public void openGui(EntityPlayer player, BlockPos pos) {
            player.openGui(ImpracticalStorage.instance, this.ordinal(), player.getEntityWorld(), pos.getX(), pos.getY(), pos.getZ());
        }
